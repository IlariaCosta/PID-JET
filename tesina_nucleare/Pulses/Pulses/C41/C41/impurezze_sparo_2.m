function impurezze_sparo_2(name_l, Lan_Ne, Lan_TE)

    %% 1. Sparo 99433 
    i = contains(name_l, '99433'); 
    sparo_1 = name_l{i};
    load(sparo_1);
    ...
    save param_impurezze_sparo_2 ci_core ci_tar ci_omp ci_T_core ci_T_tar ci_T_omp ci_energia ...
