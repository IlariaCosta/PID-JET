function impurezze_sparo_1(name_l, Lan_Ne, Lan_TE)

    %% 1. Sparo 99432 
    i = contains(name_l, '99432'); 
    sparo_1 = name_l{i};
    load(sparo_1);
...
%       media_energia_filt n_core_data_filt n_omp_data_filt n_tar_data_filt ...
    ...
    save param_impurezze_sparo_1 ci_core ci_tar ci_omp ci_T_core ci_T_tar ci_T_omp ci_energia ...
